...
```{r}
ggplot(df_clean, aes(x = year, y = Tasa_actividad, fill = Sexo)) +
  geom_boxplot() +
  labs(
  ...
  # Añadir un punto para la media para complementar la mediana del boxplot
  stat_summary(fun = mean, geom = "point", shape = 23, size = 3, fill = "darkgreen", color = "black") +
  theme_minimal()
```

...
```{r}
# Transformar los datos a su formato idóneo
...
```{r}
# Guardar los niveles
levels_sexo<-levels(df$Sexo)
levels_edad<-levels(df$Edad) # habría que ordenarlo
levels_situacion<-levels(df$Situacion_Laboral) #Ordenamos? 
```

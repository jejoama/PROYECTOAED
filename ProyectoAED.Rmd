...
```{r}
head(df[which(is.na(df$Total)),])
```

Se observa que los valores faltantes vienen asociados a grupos de edad altos, para cualquier Sexo y cuya relación con la actividad económica es "Parados que buscan primer empleo" o "Parados"
